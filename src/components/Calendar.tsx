// Add these new state variables and functions to your existing Calendar component
...
// Now replace your Action Pool section with this enhanced version:
...
// Also update your calendar day cells to handle drops:
// In your calendar grid where you render the day cells, add these handlers:
...
{daysOfWeek.map((day, dayIndex) => (
  <div
    ...
    onDragLeave={handleDragLeave}
    onDrop={(e) => handleTimeSlotDrop(e, '09:00', day)} // Default to 9 AM
  >
