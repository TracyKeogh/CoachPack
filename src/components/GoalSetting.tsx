...
const CATEGORIES: GoalCategory[] = [
  { 
    id: 'personal', 
    name: 'Personal',
    icon: <div className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-600"><Target className="w-5 h-5" /></div>,
    color: 'gray'
  },
  { 
    id: 'physical', 
    name: 'Physical',
    icon: <div className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-600"><Flag className="w-5 h-5" /></div>,
    color: 'gray'
  },
  { 
    id: 'professional', 
    name: 'Professional',
    icon: <div className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-600"><CalendarIcon className="w-5 h-5" /></div>,
    color: 'gray'
  }
];
...
const GoalSetting: React.FC = () => {
  ...
  const getTimeframeIcon = (timeframe: GoalTimeframe) => {
    switch (timeframe) {
      case 'annual': return <Target className="w-6 h-6 text-gray-700" />;
      case '90day': return <Flag className="w-6 h-6 text-gray-700" />;
      case 'weekly': return <CalendarIcon className="w-6 h-6 text-gray-700" />;
    }
  };
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        <div className="p-6">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <h3 className="text-xl font-medium text-gray-800">{CATEGORIES.find(c => c.id === category)?.name}</h3>
          </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-transparent"
                  rows={2}
                />
              </div>
              ...
              {timeframe === 'annual' && (
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Mantra (optional)</label>
                  <input
                    type="text"
                    value={newMantra}
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    {timeframe === 'annual' && goal.mantra && (
                      <p className="text-gray-500 italic mt-2">"{goal.mantra}"</p>
                    )}
                  </div>
                  <button
                         ...
                         editingAction.index === index ? (
                          <div className="flex-1 flex items-center space-x-2">
                            <input
                              ...
                              className="flex-1 p-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-transparent"
                            />
                            <button
                              onClick={saveAction}
                          ...
                          <>
                            <div className="w-1.5 h-1.5 rounded-full bg-gray-400 mt-2 mr-2 flex-shrink-0" />
                            <div className="flex-1">
                  ...
                  <div className="mt-6 border-t border-gray-200 pt-4">
                    ...
                    <div className="space-y-3">
                      {goal.milestones?.map((milestone) => (
                        <div key={milestone.id} className="flex items-start group bg-gray-50 p-3 rounded-lg border border-gray-200">
                          {editingMilestone && 
                           ...
                           editingMilestone.milestoneId === milestone.id ? (
                            <div className="flex-1 space-y-2">
                              <input
                                ...
                                className="w-full p-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-transparent"
                              ...
                              <div className="flex items-center space-x-2">
                                <input
                                  ...
                                  className="p-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-transparent"
                                />
                            ...
                            <>
                              ...
                              <div className="flex-1">
                                <div className={`font-medium ${milestone.completed ? 'text-gray-500 line-through' : 'text-gray-700'}`}>
                                  {milestone.title}
                                </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <h2 className="text-xl font-medium text-gray-800">Annual Goals</h2>
              </div>
              <button
                onClick={() => {
                  setCurrentTimeframe('annual');
                ...
                className="px-3 py-1 text-sm text-gray-600 hover:text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-100"
              >
                Edit
              </button>
            </div>
                ...
                return (
                  <div key={category.id} className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                    <div className="p-4">
                      ...
                      <p className="text-gray-700 font-medium mb-2">{goal.text}</p>
                      {goal.mantra && (
                        <p className="text-gray-500 italic text-sm">"{goal.mantra}"</p>
                      )}
                    </div>
                  </div>
                );
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <h2 className="text-xl font-medium text-gray-800">90-Day Focus</h2>
              </div>
              <button
                onClick={() => {
                  setCurrentTimeframe('90day');
                ...
                return (
                  <div key={category.id} className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                    <div className="p-4">
                      ...
                      <p className="text-gray-700 font-medium mb-3">{goal.text}</p>
                    ...
                    {goal.milestones && goal.milestones.length > 0 && (
                      <div className="mt-3 border-t border-gray-100 pt-3">
                        <h4 className="text-sm font-medium text-gray-700 mb-2 flex items-center">
                          <Trophy className="w-3 h-3 text-gray-500 mr-1" /> Milestones
                        </h4>
                        <div className="space-y-2">
                          {goal.milestones.map(milestone => (
                            <div key={milestone.id} className="flex items-center space-x-2 text-xs">
                              <div className={`w-3 h-3 rounded-full ${milestone.completed ? 'bg-gray-700' : 'bg-gray-300'}`}></div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <h2 className="text-xl font-medium text-gray-800">Weekly Actions</h2>
              </div>
              <button
                onClick={() => {
                  setCurrentTimeframe('weekly');
      ...
      <div className="space-y-6">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <div>
              <h2 className="text-xl font-medium text-gray-800">{getTimeframeTitle(currentTimeframe)}</h2>
  ...
  const renderProgressSteps = () => {
    return (
      <div className="flex items-center justify-between mb-8 bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden md:block">
            <p className={`font-medium ${currentStep === 1 ? 'text-gray-800' : 'text-gray-700'}`}>Annual Vision</p>
            <p className="text-xs text-gray-500">Your vision for the year</p>
          </div>
          ...
          <div className="hidden md:block">
            <p className={`font-medium ${currentStep === 2 ? 'text-gray-800' : 'text-gray-700'}`}>90-Day Focus</p>
            <p className="text-xs text-gray-500">Your next quarter</p>
          </div>
          <div className="w-8 h-0.5 bg-gray-200"></div>
          <div 
            className={`w-10 h-10 rounded-full flex items-center justify-center ${
              currentStep >= 3 ? 'bg-gray-800 text-white' : 'bg-gray-200 text-gray-600'
            }`}
          >
            {currentStep > 3 || showSummary ? <Check className="w-5 h-5" /> : 3}
          </div>
          <div className="hidden md:block">
            <p className={`font-medium ${currentStep === 3 ? 'text-gray-800' : 'text-gray-700'}`}>Weekly Actions</p>
            <p className="text-xs text-gray-500">Your weekly plan</p>
          </div>
          <div className="w-8 h-0.5 bg-gray-200"></div>
          <div 
            className={`w-10 h-10 rounded-full flex items-center justify-center ${
              showSummary ? 'bg-gray-800 text-white' : 'bg-gray-200 text-gray-600'
            }`}
          >
            {showSummary ? <Check className="w-5 h-5" /> : 4}
          </div>
          <div className="hidden md:block">
            <p className={`font-medium ${showSummary ? 'text-gray-800' : 'text-gray-700'}`}>Summary</p>
            <p className="text-xs text-gray-500">Review your plan</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="max-w-xl">
        <h1 className="text-2xl font-medium text-gray-800">Goal Setting</h1>
