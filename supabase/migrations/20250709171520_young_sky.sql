/*
  ...
  This migration safely checks if the user_notes table exists before attempting to create it,
  and handles all the necessary setup only if the table doesn't already exist.
*/
