/*
  # Fix user_notes table creation

  This migration checks if the user_notes table already exists before attempting to create it,
  and uses IF NOT EXISTS for all operations to avoid conflicts with previous migrations.
*/
