/*
  # Database Schema for Coach Pack Application
  
  This migration creates the core database schema for the Coach Pack application,
  including user data tables, Stripe integration tables, and security policies.
  
  1. Custom Types
     - Stripe subscription and order status enums
  2. Helper Functions
     - Timestamp update function
     - User profile creation function
  3. Core Tables
     - User profiles and preferences
     - Feature-specific data tables (wheel, values, vision, goals)
     - Notes and reflection data
