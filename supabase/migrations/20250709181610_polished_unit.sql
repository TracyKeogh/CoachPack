/*
  ...
  1. New Table
    - `user_notes` - Stores user notes related to their coaching journey
      - `id` (uuid, primary key)
  ...
  3. Features
    - Notes can be categorized (insight, action, reflection, etc.)
    - Notes can be associated with specific features (wheel, values, vision, goals)
    - Timestamps for creation and updates
*/

-- Drop table if it exists to avoid conflicts with previous migrations
