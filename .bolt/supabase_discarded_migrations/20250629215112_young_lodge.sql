/*
  ...
  including user data tables, wheel of life assessments, values clarification,
  vision boards, goals, and notes.
  
  The migration is designed to be idempotent (can be run multiple times without error)
  by checking for existing objects before creating them.
*/
